  ...
  return (
    ...
    <main className='container mt-10 mb-5'>
      <div className='tracking-tighter mb-8'>
        ...
        <p className="text-xs text-center text-gray-500">이름과 생년월일, 아이디가 일치하면 비밀번호를 변경할 수 있습니다.</p>
      </div>
      <div className='flex flex-col justify-center items-center relative'>
        ...
        <div className='flex flex-col mt-3 justify-start md:w-[80%] w-full transition-all'>
          <label className='text-[0.75rem] text-gray-500 bg-white -mb-3 ml-5 z-50 w-fit px-2'>아이디를 입력해주세요.</label>
          <input 
            type="password"
            name="checkPassword"
